...
import {DeductListListColumns} from '../util/data'
...
class DeductListListTable extends React.Component{
    constructor(props) {
        super(props);
        this.state = {
            activeId: '1',
...
export default DeductListListTable